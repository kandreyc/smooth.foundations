...
namespace Smooth.Foundations.PatternMatching.Options
{
    internal sealed class ActionSelectorForOption<T>
    {
        ...
        private readonly List<Tuple<Func<Option<T>, bool>, Either<Action<T>, Action<Option<T>>>>>  _predicatesAndActions = 
            new List<Tuple<Func<Option<T>, bool>, Either<Action<T>, Action<Option<T>>>>>();
