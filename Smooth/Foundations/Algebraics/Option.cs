...
namespace Smooth.Algebraics
{
	...
	/// <summary>
	///     Struct representing an optional value of type T.  An option that contains the value t is called a "Some" or
	///     "Some(t)".  An empty option is called a "None". Option
	///     <T>
	///         can be thought of as a far more robust version of Nullable
	///         <T>
	///             or as an IEnumerable
	///             <T>
	///                 that may contain exactly 0 or 1 element(s).
	///                 An Option
	///                 <T>
	///                     has two fields:
	///                     public readonly bool isSome;
	///                     public readonly T value;
	///                     Use the isSome field to determine if the option contains a value, and the value field to read the
	///                     value.  Nothing prevents access to the value field of an empty option, it is up to the user to
	///                     adherere to the Some / None semantics.
	/// </summary>
	[Serializable]
    public struct Option<T> : IComparable<Option<T>>, IEquatable<Option<T>>
    {
        ...
        {
            return isSome ? someFunc(value) : noneValue;
        }

	    /// <summary>
	    ///     If the option isSome, returns the result of someFunc applied to the option's value and p; otherwise, returns
	    ///     noneValue.
	    /// </summary>
	    public U Cata<U, P>(DelegateFunc<T, P, U> someFunc, P p, U noneValue)
        {
            return isSome ? someFunc(value, p) : noneValue;
        }

	    /// <summary>
	    ///     If the option isSome, returns the result of someFunc applied to the option's value; otherwise, returns the result
	    ///     of noneFunc.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     If the option isSome, returns the result of someFunc applied to the option's value and p; otherwise, returns the
	    ///     result of noneFunc.
	    /// </summary>
	    public U Cata<U, P>(DelegateFunc<T, P, U> someFunc, P p, DelegateFunc<U> noneFunc)
        {
            return isSome ? someFunc(value, p) : noneFunc();
        }

	    /// <summary>
	    ///     If the option isSome, returns the result of someFunc applied to the option's value and p; otherwise, returns the
	    ///     result of noneFunc applied to p2.
	    /// </summary>
	    public U Cata<U, P, P2>(DelegateFunc<T, P, U> someFunc, P p, DelegateFunc<P2, U> noneFunc, P2 p2)
        {
            return isSome ? someFunc(value, p) : noneFunc(p2);
        }

	    /// <summary>
	    ///     Returns true if the option contains the specified value according to the default equality comparer; otherwise,
	    ///     false.
	    /// </summary>
	    public bool Contains(T t)
        {
            return isSome && Collections.EqualityComparer<T>.Default.Equals(value, t);
        }

	    /// <summary>
	    ///     Returns true if the option contains the specified value according to the specified equality comparer; otherwise,
	    ///     false.
	    /// </summary>
	    public bool Contains(T t, IEqualityComparer<T> comparer)
        {
            return isSome && comparer.Equals(value, t);
        }
        ...
        {
            return isSome ? this : noneFunc(p);
        }

	    /// <summary>
	    ///     If the option isSome, returns an option containing the specified selector applied to the option's value; otherwise,
	    ///     returns an empty option.
	    /// </summary>
	    public Option<U> Select<U>(DelegateFunc<T, U> selector)
        {
            return isSome ? new Option<U>(selector(value)) : Option<U>.None;
        }

	    /// <summary>
	    ///     If the option isSome, returns an option containing the specified selector applied to the option's value and p;
	    ///     otherwise, returns an empty option.
	    /// </summary>
	    public Option<U> Select<U, P>(DelegateFunc<T, P, U> selector, P p)
        {
            return isSome ? new Option<U>(selector(value, p)) : Option<U>.None;
        }

	    /// <summary>
	    ///     If the option isSome, returns the specified selector applied to the option's value; otherwise, returns an empty
	    ///     option.
	    /// </summary>
	    public Option<U> SelectMany<U>(DelegateFunc<T, Option<U>> selector)
        {
            return isSome ? selector(value) : Option<U>.None;
        }

	    /// <summary>
	    ///     If the option isSome, returns the specified selector applied to the option's value and p; otherwise, returns an
	    ///     empty option.
	    /// </summary>
	    public Option<U> SelectMany<U, P>(DelegateFunc<T, P, Option<U>> selector, P p)
        {
            return isSome ? selector(value, p) : Option<U>.None;
        }
        ...
        {
            return isSome ? value : noneFunc(p);
        }

	    /// <summary>
	    ///     If the option isSome and the specified predicate applied to the option's value is true, returns the option;
	    ///     otherwise, returns an empty option.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     If the option isSome and the specified predicate applied to the option's value and p is true, returns the option;
	    ///     otherwise, returns an empty option.
	    /// </summary>
	    public Option<T> Where<P>(DelegateFunc<T, P, bool> predicate, P p)
        {
            return isSome && predicate(value, p) ? this : None;
        }

	    /// <summary>
	    ///     If the option isSome and the specified predicate applied to the option's value is false, returns the option;
	    ///     otherwise, returns an empty option.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     If the option isSome and the specified predicate applied to the option's value and p is false, returns the option;
	    ///     otherwise, returns an empty option.
	    /// </summary>
        ...
        {
            return isSome ? other.isSome ? Collections.Comparer<T>.Default.Compare(value, other.value) :
                1 :
                other.isSome ? -1 : 0;
        }
