...
namespace Smooth.Algebraics
{
    ...
    public struct Either<L, R> : IComparable<Either<L, R>>, IEquatable<Either<L, R>>
    {
	    ...
	    /// <summary>
	    ///     If the either isLeft, returns leftFunc applied to the either's value; otherwise, returns rightFunc applied to the
	    ///     either's value.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     If the either isLeft, returns leftFunc applied to the either's value and p; otherwise, returns rightFunc applied to
	    ///     the either's value.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     If the either isLeft, applies leftAction to the either's value; otherwise, applies rightAction to the either's
	    ///     value.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     If the either isLeft, applies leftAction to the either's value and p; otherwise, applies rightAction to the
	    ///     either's value.
	    /// </summary>
        ...
        {
            return isLeft
                ? EqualityComparer<L>.Default.GetHashCode(leftValue)
                : EqualityComparer<R>.Default.GetHashCode(rightValue);
        }
