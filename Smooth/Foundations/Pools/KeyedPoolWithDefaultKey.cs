...
namespace Smooth.Pools
{
	...
	public class KeyedPoolWithDefaultKey<K, T> : KeyedPool<K, T>
    {
	    ...
	    /// </summary>
	    public KeyedPoolWithDefaultKey(DelegateFunc<K, T> create, DelegateFunc<T, K> reset, K defaultKey) : base(create,
            reset)
        {
	    ...
	    ///     Creates a new keyed pool with the specified creation delegate, reset delegate, and default key.
	    /// </summary>
	    public KeyedPoolWithDefaultKey(DelegateFunc<K, T> create, DelegateFunc<T, K> reset,
            DelegateFunc<K> defaultKeyFunc) : base(create, reset)
        {
            defaultKey = Either<K, DelegateFunc<K>>.Right(defaultKeyFunc);
        }
