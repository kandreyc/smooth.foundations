...
namespace Smooth.Foundations.PatternMatching
{
    ...
    internal sealed class MatchActionSelector<T1, T2>
    {
        ...
        private readonly List<Tuple<DelegateFunc<T1, T2, bool>, Action<T1, T2>>> _testsAndActions =
            new List<Tuple<DelegateFunc<T1, T2, bool>, Action<T1, T2>>>();
    ...
    internal sealed class MatchActionSelector<T1, T2, T3>
    {
        ...
        private readonly List<Tuple<DelegateFunc<T1, T2, T3, bool>, Action<T1, T2, T3>>> _testsAndActions =
            new List<Tuple<DelegateFunc<T1, T2, T3, bool>, Action<T1, T2, T3>>>();
