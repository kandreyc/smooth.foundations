    ...
    public sealed class WithForFuncHandler<TMatcher, T1, T2, TResult>
    {
        ...
        public TMatcher Return(TResult value)
        {
            _recorder((x, y) =>
                _values
                    .Slinq()
                    .Any((t1, t2) => t1.Equals(t2), ValueTuple.Create(x, y)), (_, __) => value);
            return _matcher;
        }
    }
    ...
    public sealed class WithForFuncHandler<TMatcher, T1, T2, T3, TResult>
    {
        ...
        public TMatcher Return(TResult value)
        {
            _recorder((x, y, z) =>
                _values
                    .Slinq()
                    .Any((t1, t2) => t1.Equals(t2), ValueTuple.Create(x, y, z)), (_, __, ___) => value);
            return _matcher;
        }
    }
    ...
    public sealed class WithForFuncHandler<TMatcher, T1, T2, T3, T4, TResult>
    {
        ...
        public TMatcher Return(TResult value)
        {
            _recorder((w, x, y, z) =>
                _values
                    .Slinq()
                    .Any((t1, t2) => t1.Equals(t2), ValueTuple.Create(w, x, y, z)), (p1, p2, p3, p4) => value);
            return _matcher;
        }
    }
}