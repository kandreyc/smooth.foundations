...
namespace Smooth.Events
{
	...
	public struct GenericEvent<T1, T2, T3>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3);
        }
    }
	...
	public struct GenericEvent<T1, T2, T3, T4>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3, t4);
        }
    }
	...
	public struct GenericEvent<T1, T2, T3, T4, T5>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3, t4, t5);
        }
    }
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3, t4, t5, t6);
        }
    }
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6, T7>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3, t4, t5, t6, t7);
        }
    }
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3, t4, t5, t6, t7, t8);
        }
    }
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    {
        ...
        {
            var handle = Handle;
            if (handle != null) handle(t1, t2, t3, t4, t5, t6, t7, t8, t9);
        }
    }
}