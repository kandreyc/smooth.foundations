...
namespace Smooth.Comparisons
{
	...
	public static class Comparisons
    {
	    ...
	    /// <summary>
	    ///     Converts the specified comparison for value type T into a comparison for Nullable
	    ///     <T>s, with nulls preceeding non-nulls.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Converts the specified comparison for value type T into a comparison for Nullable
	    ///     <T>s, with nulls suceeding non-nulls.
	    /// </summary>
    ...
    {
        private static readonly Dictionary<IComparer<T>, Comparison<T>> toComparison =
            new Dictionary<IComparer<T>, Comparison<T>>();

        private static readonly Dictionary<IEqualityComparer<T>, DelegateFunc<T, T, bool>> toPredicate =
            new Dictionary<IEqualityComparer<T>, DelegateFunc<T, T, bool>>();

	    /// <summary>
	    ///     The comparison method of the default sort comparer for T in delegate form.
	    /// </summary>
	    public static Comparison<T> Default => ToComparison(Collections.Comparer<T>.Default);

	    /// <summary>
	    ///     The comparison method of the default equality comparer for T in delegate form.
	    /// </summary>
	    public static DelegateFunc<T, T, bool> DefaultPredicate => ToPredicate(Collections.EqualityComparer<T>.Default);
