...
{
	/// <summary>
	///     Performs type-specific equality comparisons and hashCode generation using the functions supplied to the
	///     constructor.
	/// </summary>
	public class FuncEqualityComparer<T> : Collections.EqualityComparer<T>
    {
        ...
        {
            this.equals = equals;
            hashCode = typeof(T).IsClass
                ? t => t == null ? 0 : t.GetHashCode()
                : (DelegateFunc<T, int>) (t => t.GetHashCode());
        }
