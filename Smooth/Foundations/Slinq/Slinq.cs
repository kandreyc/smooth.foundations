...
namespace Smooth.Slinq
{
	...
	///     current, which is either a Some option containing the current value of the enumeration, or a None option if the
	///     enumeration is complete.
	///     Skip, which moves the Slinq to the next element in the enumeration.
	///     Remove, which removes the current element from the underlying representation and moves the Slinq to the next
	...
	///     If a Skip or Remove call completes the enumeration, any shared resources held by the Slinq will be released
	///     automatically.  Dispose only needs to be called when abandoning an incomplete enumeration.
	///     Slinq
	///     <T, C>
	///         and its extension classes define many operations inspired by Linq and functional programming languages such as
	///         Scala and F#.
	///         Slinq methods that take delegate parameter(s) come in two forms, a basic version and a version that takes an
	///         additional, user defined parameter of generic type P.  This extra parameter is passed to the delegate(s) in
	///         order to capture any state required for the operation without the need for a closure.
	///         Note: Because Slinqs are value types, it is possible to backtrack to an earlier point in an enumeration by
	///         storing multiple copies of a Slinq.  This is not supported and will lead to unspecified behavior.
	///         If DETECT_BACKTRACK is defined in Smooth.Slinq.Context.BacktrackDetector, backtracking will be detected and
	///         throw an exception.  This should only be used for debugging purposes as it will severely reduce performance.
	/// </summary>
	public struct Slinq<T, C>
    {
	    ...
	    /// <summary>
	    ///     Either a Some option containing the current value of the enumeration, or a None option if the enumeration is
	    ///     complete.
	    ...
	    public void Skip()
        {
            if (current.isSome) skip(ref context, out current);
        }

	    /// <summary>
	    ///     Moves the Slinq to the next element in the enumeration and returns the Slinq.  If the Slinq is empty this will have
	    ///     no effect.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Removes the current element from the underlying sequence and moves the Slinq to the next element in the
	    ///     enumeration.  If the Slinq is empty this will have no effect.
	    /// </summary>
	    ...
	    public void Remove()
        {
            if (current.isSome) remove(ref context, out current);
        }

	    /// <summary>
	    ///     Removes the current element from the underlying sequence, moves the Slinq to the next element in the enumeration,
	    ///     and returns the Slinq.  If the Slinq is empty this will have no effect.
	    /// </summary>
	    /// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
	    ...
	    /// <summary>
	    ///     Sets the current value of the Slinq to None and releases any shared resources held by the Slinq.  If the Slinq is
	    ///     empty this will have no effect.
	    ///     Slinqs are automatically disposed when they become empty, but if you are done with a Slinq that still contains
	    ///     values, you must call Dispose to ensure the release and/or disposal of any resources held by the Slinq.
	    /// </summary>
	    public void Dispose()
        {
            if (current.isSome) dispose(ref context, out current);
        }
	    ...
	    public void SkipAll()
        {
            while (current.isSome) skip(ref context, out current);
        }

	    /// <summary>
	    ///     Enumerates up to the specified number of elements from the Slinq.
	    ///     If count is greater than or equal to the number of elements remaining, all the remaining elements will be
	    ///     enumerated.
        ...
        {
            while (current.isSome && count-- > 0) skip(ref context, out current);
            return this;
        }

	    /// <summary>
	    ///     Enumerates elements from the Slinq while the specified predicate returns true.
	    ///     After perfoming this operation, the Slinq will be positioned on the first element for which the predicate returns
	    ///     false.
	    /// </summary>
	    public Slinq<T, C> SkipWhile(DelegateFunc<T, bool> predicate)
        {
            while (current.isSome && predicate(current.value)) skip(ref context, out current);
            return this;
        }
        ...
        {
            while (current.isSome && predicate(current.value, parameter)) skip(ref context, out current);
            return this;
        }

	    /// <summary>
	    ///     Aggregates elements from the Slinq while the specified selector returns a Some option.
	    ///     After perfoming this operation, the Slinq will be positioned on the first element for which the selector returns
	    ///     None.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Enumerates the remaining elements from the Slinq, removes them from the underlying sequence, and returns the number
	    ///     of elements removed.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    /// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
	    ...
	    ///     Enumerates the remaining elements from the Slinq, removes them from the underlying sequence, and returns the number
	    ///     of elements removed.
	    ///     After an element is removed the specified then action will be called with the element and the specified then
	    ///     parameter.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    /// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
        ...
        {
            while (current.isSome && count-- > 0) remove(ref context, out current);
            return this;
        }
	    ...
	    /// <summary>
	    ///     Enumerates elements from the Slinq and removes them from the underlying sequence while the specified predicate
	    ///     returns true.
	    ///     After perfoming this operation, the Slinq will be positioned on the first element for which the predicate returns
	    ///     false.
	    /// </summary>
        ...
        {
            while (current.isSome && predicate(current.value)) remove(ref context, out current);
            return this;
        }
	    ...
	    ///     Enumerates elements from the Slinq and removes them from the underlying sequence while the specified predicate
	    ///     returns true.
	    ///     After an element is removed the specified then action will be called with the element and the specifed then
	    ///     parameter.
	    ///     After perfoming this operation, the Slinq will be positioned on the first element for which the predicate returns
	    ///     false.
	    /// </summary>
        ...
        {
            while (current.isSome && predicate(current.value, parameter)) remove(ref context, out current);
            return this;
        }
	    ...
	    /// </summary>
	    /// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
	    public Slinq<T, C> RemoveWhile<P, P2>(DelegateFunc<T, P, bool> predicate, P parameter,
            DelegateAction<T, P2> then, P2 thenParameter)
        {
            while (current.isSome && predicate(current.value, parameter))
            {
                var removed = current.value;
	    ...
	    /// <summary>
	    ///     Aggregates elements from the Slinq and removes them from the underlying sequence while the specified selector
	    ...
	    /// </summary>
	    /// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
	    public U RemoveWhile<U, P>(U seed, DelegateFunc<U, T, Option<U>> selector, DelegateAction<T, P> then,
            P thenParameter)
        {
            while (current.isSome)
            {
	    ...
	    /// </summary>
	    /// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
	    public U RemoveWhile<U, P, P2>(U seed, DelegateFunc<U, T, P, Option<U>> selector, P parameter,
            DelegateAction<T, P2> then, P2 thenParameter)
        {
            while (current.isSome)
            {
	    ...
	    /// <summary>
	    ///     Analog to Enumerable.ElementAt(), but returns an option rather than throwing an exception if the element does not
	    ///     exist.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    public Option<T> ElementAtOrNone(int index)
        {
            if (index > 0) return Skip(index - 1).FirstOrNone();

            if (index == 0) return FirstOrNone();
	    ...
	    public Option<T> LastOrNone(DelegateFunc<T, bool> predicate)
        {
            ...
            while (current.isSome)
            {
                if (predicate(current.value)) last = current;
                skip(ref context, out current);
            }
	    ...
	    public Option<T> LastOrNone<P>(DelegateFunc<T, P, bool> predicate, P parameter)
        {
            ...
            while (current.isSome)
            {
                if (predicate(current.value, parameter)) last = current;
                skip(ref context, out current);
            }
	    ...
	    /// <summary>
	    ///     Analog to Enumerable.Max(), but returns an option rather than throwing an exception if the Slinq is empty and T is
	    ///     a value type.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    ...
	    public Option<T> MaxOrNone(Comparison<T> comparison)
        {
            if (current.isSome)
            {
                ...
                while (current.isSome)
                {
                    if (comparison(value, current.value) < 0) value = current.value;
                    skip(ref context, out current);
                }
	    ...
	    /// <summary>
	    ///     Analog to Enumerable.Min(), but returns an option rather than throwing an exception if the Slinq is empty and T is
	    ///     a value type.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Analog to Enumerable.Single(), but returns an option rather than throwing an exception if the Slinq is empty or
	    ...
	    /// <summary>
	    ///     Splits the remaining elements into a pair of lists, with the first list containing elements starting from the
	    ///     current position of the Slinq and the second list containing up to the last count elements from the end of the
	    ///     Slinq.
	    ///     If count is greater than or equal to the number of elements remaining, the first list will be empty and the second
	    ///     list will contain all the remaining elements.
	    ///     If count is less than or equal to zero, the first list will contain all the remaining elements and the second list
	    ///     will be empty.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    public ValueTuple<LinkedHeadTail<T>, LinkedHeadTail<T>> SplitRight(int count)
        {
            if (current.isSome)
            {
                ...
                return ValueTuple.Create(ToLinked(), new LinkedHeadTail<T>());
            }

            return ValueTuple.Create(default(LinkedHeadTail<T>), default(LinkedHeadTail<T>));
        }
	    ...
	    /// <summary>
	    ///     Adds the remaining elements in the Slinq to the specified collection using the specified selector and returns the
	    ///     collection.
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    ...
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    public Disposable<IC> AddTo<U, IC>(Disposable<IC> collection, DelegateFunc<T, U> selector)
            where IC : ICollection<U>
        {
	    ...
	    ///     This operation will consume and dispose the Slinq.
	    /// </summary>
	    public Disposable<IC> AddTo<U, IC, P>(Disposable<IC> collection, DelegateFunc<T, P, U> selector, P parameter)
            where IC : ICollection<U>
        {
	    ...
	    /// <summary>
	    ///     Adds the remaining elements in the Slinq to the specified LinkedHeadTail
	    ///     <T>
	    ...
	    ///     Adds the remaining elements in the Slinq to the specified LinkedHeadTail
	    ///     <K, T>
	    ///         using the specified key selector and returns the result.
	    ///         This operation will consume and dispose the Slinq.
	    /// </summary>
	    ...
	    ///     Adds the remaining elements in the Slinq to the specified LinkedHeadTail
	    ///     <K, T>
	    ///         in reverse order using the specified key selector and returns the result.
	    ///         This operation will consume and dispose the Slinq.
	    /// </summary>
	    ...
	    ///         This operation will consume and dispose the Slinq.
	    /// </summary>
	    public LinkedHeadTail<K, T> AddToReverse<K, P>(LinkedHeadTail<K, T> list, DelegateFunc<T, P, K> selector,
            P parameter)
        {
            if (current.isSome)
            {
	    ...
	    /// <summary>
	    ///     Adds the remaining elements in the Slinq to the specified Lookup
	    ///     <K, T>
	    ///         using the specified key selector and returns the lookup.
	    ///         This operation will consume and dispose the Slinq.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Converts the Slinq into a List
	    ///     <T>
	    ///         borrowed from ListPool
	    ///         <T>
	    ///             .
	    ///             This operation will consume and dispose the Slinq.
	    /// </summary>
	...
	public static class Slinq
    {
	    ...
	    /// </summary>
	    public static Slinq<U, AggregateContext<U, T, C>> AggregateRunning<U, T, C>(this Slinq<T, C> slinq, U seed,
	    ...
	    ///     Returns a chained Slinq that performs a running aggegatation over the specified Slinq.
	    /// </summary>
	    public static Slinq<U, AggregateContext<U, T, C, P>> AggregateRunning<U, T, C, P>(this Slinq<T, C> slinq,
            U seed, DelegateFunc<U, T, P, U> selector, P parameter)
        {
	    ...
	    ///     Analog to Enumerable.Distinct().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C>> Distinct<K, T, C>(this Slinq<T, C> slinq,
	    ...
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C>> Distinct<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, IEqualityComparer<K> comparer)
        {
            return HashSetContext<K, T, C>.Distinct(slinq, selector, HashSetPool<K>.Instance.BorrowDisposable(comparer),
                true);
        }
	    ...
	    ///     Analog to Enumerable.Distinct().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C, P>> Distinct<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter)
        {
            return HashSetContext<K, T, C, P>.Distinct(slinq, selector, parameter,
                HashSetPool<K>.Instance.BorrowDisposable(), true);
        }
	    ...
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C, P>> Distinct<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter, IEqualityComparer<K> comparer)
        {
            return HashSetContext<K, T, C, P>.Distinct(slinq, selector, parameter,
                HashSetPool<K>.Instance.BorrowDisposable(comparer), true);
        }
	    ...
	    public static Slinq<T, HashSetContext<T, C>> Except<C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other,
            IEqualityComparer<T> comparer)
        {
            return HashSetContext<T, C>.Except(slinq, other.AddTo(HashSetPool<T>.Instance.BorrowDisposable(comparer)),
                true);
        }
	    ...
	    ///     Analog to Enumerable.Except().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C>> Except<K, C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other,
            DelegateFunc<T, K> selector)
        {
            return HashSetContext<K, T, C>.Except(slinq, selector,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(), selector), true);
        }
        ...
        {
            return HashSetContext<K, T, C>.Except(slinq, selector,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(comparer), selector), true);
        }

	    /// <summary>
	    ///     Analog to Enumerable.Except().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C, P>> Except<K, C2, T, C, P>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, DelegateFunc<T, P, K> selector, P parameter)
        {
            return HashSetContext<K, T, C, P>.Except(slinq, selector, parameter,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(), selector, parameter), true);
        }
	    ...
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C, P>> Except<K, C2, T, C, P>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, DelegateFunc<T, P, K> selector, P parameter, IEqualityComparer<K> comparer)
        {
            return HashSetContext<K, T, C, P>.Except(slinq, selector, parameter,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(comparer), selector, parameter), true);
        }
	    ...
	    /// </summary>
	    public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> GroupBy<K, T, C>(
            this Slinq<T, C> slinq, DelegateFunc<T, K> selector)
        {
	    ...
	    /// </summary>
	    public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> GroupBy<K, T, C>(
            this Slinq<T, C> slinq, DelegateFunc<T, K> selector, IEqualityComparer<K> comparer)
        {
	    ...
	    ///     Analog to Enumerable.GroupBy().
	    /// </summary>
	    public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> GroupBy<K, T, C, P>(
            this Slinq<T, C> slinq, DelegateFunc<T, P, K> selector, P parameter)
        {
            return slinq.ToLookup(selector, parameter, Smooth.Collections.EqualityComparer<K>.Default)
                .SlinqAndDispose();
        }
	    ...
	    /// </summary>
	    public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> GroupBy<K, T, C, P>(
            this Slinq<T, C> slinq, DelegateFunc<T, P, K> selector, P parameter, IEqualityComparer<K> comparer)
        {
	    ...
	    /// </summary>
	    public static Slinq<U, GroupJoinContext<U, K, T2, T, C>> GroupJoin<U, K, T2, C2, T, C>(this Slinq<T, C> outer,
            Slinq<T2, C2> inner, DelegateFunc<T, K> outerSelector, DelegateFunc<T2, K> innerSelector,
            DelegateFunc<T, Slinq<T2, LinkedContext<T2>>, U> resultSelector)
        {
            return inner.ToLookup(innerSelector, Smooth.Collections.EqualityComparer<K>.Default)
                .GroupJoinAndDispose(outer, outerSelector, resultSelector);
        }
	    ...
	    public static Slinq<U, GroupJoinContext<U, K, T2, T, C>> GroupJoin<U, K, T2, C2, T, C>(this Slinq<T, C> outer,
            Slinq<T2, C2> inner, DelegateFunc<T, K> outerSelector, DelegateFunc<T2, K> innerSelector,
            DelegateFunc<T, Slinq<T2, LinkedContext<T2>>, U> resultSelector, IEqualityComparer<K> comparer)
        {
	    ...
	    ///     Analog to Enumerable.GroupJoin(), with removal operations chained to the outer Slinq.
	    /// </summary>
	    public static Slinq<U, GroupJoinContext<U, K, T2, T, C, P>> GroupJoin<U, K, T2, C2, T, C, P>(
            this Slinq<T, C> outer, Slinq<T2, C2> inner, DelegateFunc<T, P, K> outerSelector,
            DelegateFunc<T2, P, K> innerSelector, DelegateFunc<T, Slinq<T2, LinkedContext<T2>>, P, U> resultSelector,
            P parameter)
        {
            return inner.ToLookup(innerSelector, parameter, Smooth.Collections.EqualityComparer<K>.Default)
                .GroupJoinAndDispose(outer, outerSelector, resultSelector, parameter);
        }
	    ...
	    public static Slinq<U, GroupJoinContext<U, K, T2, T, C, P>> GroupJoin<U, K, T2, C2, T, C, P>(
            this Slinq<T, C> outer, Slinq<T2, C2> inner, DelegateFunc<T, P, K> outerSelector,
            DelegateFunc<T2, P, K> innerSelector, DelegateFunc<T, Slinq<T2, LinkedContext<T2>>, P, U> resultSelector,
            P parameter, IEqualityComparer<K> comparer)
        {
            return inner.ToLookup(innerSelector, parameter, comparer)
                .GroupJoinAndDispose(outer, outerSelector, resultSelector, parameter);
        }
	    ...
	    public static Slinq<T, HashSetContext<T, C>> Intersect<C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other,
            IEqualityComparer<T> comparer)
        {
            return HashSetContext<T, C>.Intersect(slinq,
                other.AddTo(HashSetPool<T>.Instance.BorrowDisposable(comparer)), true);
        }

	    /// <summary>
	    ///     Analog to Enumerable.Intersect().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C>> Intersect<K, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, DelegateFunc<T, K> selector)
        {
            return HashSetContext<K, T, C>.Intersect(slinq, selector,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(), selector), true);
        }
	    ...
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C>> Intersect<K, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, DelegateFunc<T, K> selector, IEqualityComparer<K> comparer)
        {
            return HashSetContext<K, T, C>.Intersect(slinq, selector,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(comparer), selector), true);
        }
	    ...
	    ///     Analog to Enumerable.Intersect().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, C, P>> Intersect<K, C2, T, C, P>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, DelegateFunc<T, P, K> selector, P parameter)
        {
            return HashSetContext<K, T, C, P>.Intersect(slinq, selector, parameter,
                other.AddTo(HashSetPool<K>.Instance.BorrowDisposable(), selector, parameter), true);
        }
	    ...
	    /// </summary>
	    public static Slinq<U, JoinContext<U, K, T2, T, C>> Join<U, K, T2, C2, T, C>(this Slinq<T, C> outer,
            Slinq<T2, C2> inner, DelegateFunc<T, K> outerSelector, DelegateFunc<T2, K> innerSelector,
            DelegateFunc<T, T2, U> resultSelector)
        {
            return inner.ToLookup(innerSelector, Smooth.Collections.EqualityComparer<K>.Default)
                .JoinAndDispose(outer, outerSelector, resultSelector);
        }
	    ...
	    public static Slinq<U, JoinContext<U, K, T2, T, C>> Join<U, K, T2, C2, T, C>(this Slinq<T, C> outer,
            Slinq<T2, C2> inner, DelegateFunc<T, K> outerSelector, DelegateFunc<T2, K> innerSelector,
            DelegateFunc<T, T2, U> resultSelector, IEqualityComparer<K> comparer)
        {
	    ...
	    ///     Analog to Enumerable.Join(), with removal operations chained to the outer Slinq.
	    /// </summary>
	    public static Slinq<U, JoinContext<U, K, T2, T, C, P>> Join<U, K, T2, C2, T, C, P>(this Slinq<T, C> outer,
            Slinq<T2, C2> inner, DelegateFunc<T, P, K> outerSelector, DelegateFunc<T2, P, K> innerSelector,
            DelegateFunc<T, T2, P, U> resultSelector, P parameter)
        {
            return inner.ToLookup(innerSelector, parameter, Smooth.Collections.EqualityComparer<K>.Default)
                .JoinAndDispose(outer, outerSelector, resultSelector, parameter);
        }
	    ...
	    public static Slinq<U, JoinContext<U, K, T2, T, C, P>> Join<U, K, T2, C2, T, C, P>(this Slinq<T, C> outer,
            Slinq<T2, C2> inner, DelegateFunc<T, P, K> outerSelector, DelegateFunc<T2, P, K> innerSelector,
            DelegateFunc<T, T2, P, U> resultSelector, P parameter, IEqualityComparer<K> comparer)
        {
            return inner.ToLookup(innerSelector, parameter, comparer)
                .JoinAndDispose(outer, outerSelector, resultSelector, parameter);
        }
	    ...
	    ///     This method uses a linked list merge sort algorithm and has O(n) space complexity and O(n log n) average and worst
	    ///     case time complexity.
	    ///     Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you
	    ///     should supply a composite key and/or comparision.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Returns a chained Slinq that enumerates the elements of the specified Slinq as ordered by the specified key
	    ///     selector, comparison, and ordering.
	    ///     This method uses a linked list merge sort algorithm and has O(n) space complexity and O(n log n) average and worst
	    ///     case time complexity.
	    ///     Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you
	    ///     should supply a composite key and/or comparision.
	    ...
	    ///     should supply a composite key and/or comparision.
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, IComparer<K> comparer)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, Comparison<K> comparison)
        {
	    ...
	    ///     should supply a composite key and/or comparision.
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, Comparison<K> comparison, bool ascending)
        {
            return slinq.current.isSome
	    ...
	    ///     should supply a composite key and/or comparision.
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter)
        {
            return OrderBy(slinq, selector, parameter,
                Comparisons<K>.ToComparison(Smooth.Collections.Comparer<K>.Default), true);
        }
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter, IComparer<K> comparer)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter, Comparison<K> comparison)
        {
	    ...
	    ///     should supply a composite key and/or comparision.
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter)
        {
            return OrderBy(slinq, selector, parameter,
                Comparisons<K>.ToComparison(Smooth.Collections.Comparer<K>.Default), false);
        }
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter, Comparison<K> comparison, bool ascending)
        {
            return slinq.current.isSome
	    ...
	    /// <summary>
	    ///     Returns a chained Slinq that enumerates the elements of the specified Slinq ordered by grouping the elements
	    ///     according to the specified key selector and the default equality comparer for K, with the groups ordered by the
	    ///     default sort order comparer for K.
	    ///     This method has O(n + k) space compexity and O(n + k log k) time complexity where n is the number of elements and k
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroup<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector)
        {
            return slinq.ToLookup(selector, Smooth.Collections.EqualityComparer<K>.Default)
                .SortKeys(Comparisons<K>.Default, true).FlattenAndDispose().SlinqAndDispose();
        }

	    /// <summary>
	    ///     Returns a chained Slinq that enumerates the elements of the specified Slinq ordered by grouping the elements
	    ///     according to the specified key selector and equality comparer, with the groups ordered by the specified sort order
	    ///     comparer.
	    ///     This method has O(n + k) space compexity and O(n + k log k) time complexity where n is the number of elements and k
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroup<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, IEqualityComparer<K> equalityComparer, IComparer<K> comparer)
        {
            return slinq.ToLookup(selector, equalityComparer).SortKeys(Comparisons<K>.ToComparison(comparer), true)
                .FlattenAndDispose().SlinqAndDispose();
        }

	    /// <summary>
	    ///     Returns a chained Slinq that enumerates the elements of the specified Slinq ordered by grouping the elements
	    ///     according to the specified key selector and equality comparer, with the groups ordered by the specified comparison.
	    ///     This method has O(n + k) space compexity and O(n + k log k) time complexity where n is the number of elements and k
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroup<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, IEqualityComparer<K> equalityComparer, Comparison<K> comparison)
        {
            return slinq.ToLookup(selector, equalityComparer).SortKeys(comparison, true).FlattenAndDispose()
                .SlinqAndDispose();
        }

	    /// <summary>
	    ///     Returns a chained Slinq that enumerates the elements of the specified Slinq ordered by grouping the elements
	    ///     according to the specified key selector and the default equality comparer for K, with the groups ordered
	    ///     descendingly by the default sort order comparer for K.
	    ///     This method has O(n + k) space compexity and O(n + k log k) time complexity where n is the number of elements and k
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroupDescending<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector)
        {
            return slinq.ToLookup(selector, Smooth.Collections.EqualityComparer<K>.Default)
                .SortKeys(Comparisons<K>.Default, false).FlattenAndDispose().SlinqAndDispose();
        }

	    /// <summary>
	    ///     Returns a chained Slinq that enumerates the elements of the specified Slinq ordered by grouping the elements
	    ///     according to the specified key selector and equality comparer, with the groups ordered descendingly by the
	    ///     specified sort order comparer.
	    ///     This method has O(n + k) space compexity and O(n + k log k) time complexity where n is the number of elements and k
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroupDescending<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, IEqualityComparer<K> equalityComparer, IComparer<K> comparer)
        {
            return slinq.ToLookup(selector, equalityComparer).SortKeys(Comparisons<K>.ToComparison(comparer), false)
                .FlattenAndDispose().SlinqAndDispose();
        }
	    ...
	    public static Slinq<T, LinkedContext<T>> OrderByGroupDescending<K, T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, K> selector, IEqualityComparer<K> equalityComparer, Comparison<K> comparison)
        {
            return slinq.ToLookup(selector, equalityComparer).SortKeys(comparison, false).FlattenAndDispose()
                .SlinqAndDispose();
        }
	    ...
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroup<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter)
        {
            return slinq.ToLookup(selector, parameter, Smooth.Collections.EqualityComparer<K>.Default)
                .SortKeys(Comparisons<K>.Default, true).FlattenAndDispose().SlinqAndDispose();
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroup<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter, IEqualityComparer<K> equalityComparer, IComparer<K> comparer)
        {
            return slinq.ToLookup(selector, parameter, equalityComparer)
                .SortKeys(Comparisons<K>.ToComparison(comparer), true).FlattenAndDispose().SlinqAndDispose();
        }
	    ...
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroup<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter, IEqualityComparer<K> equalityComparer,
            Comparison<K> comparison)
        {
            return slinq.ToLookup(selector, parameter, equalityComparer).SortKeys(comparison, true).FlattenAndDispose()
                .SlinqAndDispose();
        }
	    ...
	    ///     is the number of keys.
	    /// </summary>
	    public static Slinq<T, LinkedContext<T>> OrderByGroupDescending<K, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, K> selector, P parameter)
        {
            return slinq.ToLookup(selector, parameter, Smooth.Collections.EqualityComparer<K>.Default)
                .SortKeys(Comparisons<K>.Default, false).FlattenAndDispose().SlinqAndDispose();
        ...
        {
            return slinq.ToLookup(selector, parameter, equalityComparer)
                .SortKeys(Comparisons<K>.ToComparison(comparer), false).FlattenAndDispose().SlinqAndDispose();
        }
	    ...
	    public static Slinq<T, LinkedContext<T>> OrderByGroupDescending<K, T, C, P>(this Slinq<T, C> slinq,
            ...
            Comparison<K> comparison)
        {
            return slinq.ToLookup(selector, parameter, equalityComparer).SortKeys(comparison, false).FlattenAndDispose()
                .SlinqAndDispose();
        }
        ...
        {
            return slinq.current.isSome ? slinq.ToLinkedReverse().SlinqAndDispose() : new Slinq<T, LinkedContext<T>>();
        }

	    /// <summary>
	    ///     Analog to Enumerable.Select().
	    /// </summary>
	    public static Slinq<U, SelectContext<U, T, C>> Select<U, T, C>(this Slinq<T, C> slinq,
	    ...
	    ///     Analog to Enumerable.Select().
	    /// </summary>
	    public static Slinq<U, SelectContext<U, T, C, P>> Select<U, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, U> selector, P parameter)
        {
	    ...
	    /// </summary>
	    public static Slinq<U, SelectSlinqContext<U, UC, T, C>> SelectMany<U, UC, T, C>(this Slinq<T, C> slinq,
	    ...
	    ///     Analog to Enumerable.SelectMany().
	    /// </summary>
	    public static Slinq<U, SelectSlinqContext<U, UC, T, C, P>> SelectMany<U, UC, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, Slinq<U, UC>> selector, P parameter)
        {
	    ...
	    ///     Analog to Enumerable.SelectMany().
	    /// </summary>
	    public static Slinq<U, SelectOptionContext<U, T, C>> SelectMany<U, T, C>(this Slinq<T, C> slinq,
	    ...
	    ///     Analog to Enumerable.SelectMany().
	    /// </summary>
	    public static Slinq<U, SelectOptionContext<U, T, C, P>> SelectMany<U, T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, Option<U>> selector, P parameter)
        {
	    ...
	    ///     If count is greater than or equal to the number of elements remaining, the returned Slinq will contain all the
	    ///     remaining elements.
	    ...
	    /// </summary>
	    public static Slinq<T, PredicateContext<T, C>> TakeWhile<T, C>(this Slinq<T, C> slinq,
	    ...
	    ///     Analog to Enumerable.TakeWhile().
	    /// </summary>
	    public static Slinq<T, PredicateContext<T, C, P>> TakeWhile<T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, bool> predicate, P parameter)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, PredicateContext<T, C>> Where<T, C>(this Slinq<T, C> slinq,
            DelegateFunc<T, bool> predicate)
        {
	    ...
	    ///     Analog to Enumerable.Where().
	    /// </summary>
	    public static Slinq<T, PredicateContext<T, C, P>> Where<T, C, P>(this Slinq<T, C> slinq,
            DelegateFunc<T, P, bool> predicate, P parameter)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, HashSetContext<T, ConcatContext<C2, T, C>>> Union<C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T, C2> other)
        {
	    ...
	    /// </summary>
	    public static Slinq<T, HashSetContext<T, ConcatContext<C2, T, C>>> Union<C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, IEqualityComparer<T> comparer)
        {
	    ...
	    ///     Analog to Enumerable.Union().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, ConcatContext<C2, T, C>>> Union<K, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T, C2> other, DelegateFunc<T, K> selector)
        {
	    ...
	    ///     Analog to Enumerable.Union().
	    /// </summary>
	    public static Slinq<T, HashSetContext<K, T, ConcatContext<C2, T, C>, P>> Union<K, C2, T, C, P>(
            this Slinq<T, C> slinq, Slinq<T, C2> other, DelegateFunc<T, P, K> selector, P parameter)
        {
	    ...
	    /// </summary>
	    public static Slinq<ValueTuple<T, T2>, ZipContext<T2, C2, T, C>> Zip<T2, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with)
        {
	    ...
	    /// <summary>
	    ///     Analog to Enumerable.Zip() that combines elements into tuples and chains removal operations to the the specified
	    ///     Slinq(s).
	    /// </summary>
	    public static Slinq<ValueTuple<T, T2>, ZipContext<T2, C2, T, C>> Zip<T2, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, ZipRemoveFlags removeFlags)
        {
	    ...
	    /// </summary>
	    public static Slinq<U, ZipContext<U, T2, C2, T, C>> Zip<U, T2, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<T, T2, U> selector)
        {
	    ...
	    /// </summary>
	    public static Slinq<U, ZipContext<U, T2, C2, T, C>> Zip<U, T2, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<T, T2, U> selector, ZipRemoveFlags removeFlags)
        {
	    ...
	    ///     Analog to Enumerable.Zip() that chains removal operations to the left Slinq.
	    /// </summary>
	    public static Slinq<U, ZipContext<U, T2, C2, T, C, P>> Zip<U, T2, C2, T, C, P>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<T, T2, P, U> selector, P parameter)
        {
	    ...
	    /// </summary>
	    public static Slinq<U, ZipContext<U, T2, C2, T, C, P>> Zip<U, T2, C2, T, C, P>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<T, T2, P, U> selector, P parameter, ZipRemoveFlags removeFlags)
        {
            return ZipContext<U, T2, C2, T, C, P>.Zip(slinq, with, selector, parameter, removeFlags);
        }

	    /// <summary>
	    ///     Returns a Slinq that combines the corresponding elements from the supplied Slinqs into tuples and chains removal
	    ///     operations to the left Slinq.
	    ///     The returned Slinq will continue enumerating until it reaches the end of the longer of the supplied Slinqs.
	    ///     While a Slinq has elements remaining, the enumerated tuples will contain Some options containing the corresponding
	    ///     elements from the Slinq in the corresponding position.
	    ///     If either of the Slinqs is empty while the other still has elements remaining, the enumerated tuples will contain
	    ///     None options in place of the shorter Slinq's element until the enumeration is complete.
	    ///     Removal operations will not be chained to an empty Slinq.
	    /// </summary>
	    public static Slinq<ValueTuple<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> ZipAll<T2, C2, T, C>(
            this Slinq<T, C> slinq, Slinq<T2, C2> with)
        {
	    ...
	    /// <summary>
	    ///     Returns a Slinq that combines the corresponding elements from the supplied Slinqs into tuples and chains removal
	    ///     operations to the specified Slinq(s).
	    ///     The returned Slinq will continue enumerating until it reaches the end of the longer of the supplied Slinqs.
	    ///     While a Slinq has elements remaining, the enumerated tuples will contain Some options containing the corresponding
	    ///     elements from the Slinq in the corresponding position.
	    ///     If either of the Slinqs is empty while the other still has elements remaining, the enumerated tuples will contain
	    ...
	    /// </summary>
	    public static Slinq<ValueTuple<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> ZipAll<T2, C2, T, C>(
            this Slinq<T, C> slinq, Slinq<T2, C2> with, ZipRemoveFlags removeFlags)
        {
            return ZipAllContext<T2, C2, T, C>.ZipAll(slinq, with, removeFlags);
        }

	    /// <summary>
	    ///     Returns a Slinq that combines the corresponding elements from the supplied Slinqs using the supplied selector and
	    ///     chains removal operations to the left Slinq.
	    ///     The returned Slinq will continue enumerating until it reaches the end of the longer of the supplied Slinqs.
	    ///     While a Slinq has elements remaining, the selector will be passed Some options containing the corresponding
	    ///     elements from the Slinq.
	    ///     If either of the Slinqs is empty while the other still has elements remaining, None options will be passed to the
	    ///     selector in place of the shorter Slinq's element until the enumeration is complete.
	    ///     Removal operations will not be chained to an empty Slinq.
	    /// </summary>
	    public static Slinq<U, ZipAllContext<U, T2, C2, T, C>> ZipAll<U, T2, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<Option<T>, Option<T2>, U> selector)
        {
	    ...
	    /// <summary>
	    ///     Returns a Slinq that combines the corresponding elements from the supplied Slinqs using the supplied selector and
	    ///     chains removal operations to the specified Slinq(s).
	    ///     The returned Slinq will continue enumerating until it reaches the end of the longer of the supplied Slinqs.
	    ///     While a Slinq has elements remaining, the selector will be passed Some options containing the corresponding
	    ///     elements from the Slinq.
	    ///     If either of the Slinqs is empty while the other still has elements remaining, None options will be passed to the
	    ...
	    /// </summary>
	    public static Slinq<U, ZipAllContext<U, T2, C2, T, C>> ZipAll<U, T2, C2, T, C>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<Option<T>, Option<T2>, U> selector, ZipRemoveFlags removeFlags)
        {
	    ...
	    ///     Removal operations will not be chained to an empty Slinq.
	    /// </summary>
	    public static Slinq<U, ZipAllContext<U, T2, C2, T, C, P>> ZipAll<U, T2, C2, T, C, P>(this Slinq<T, C> slinq,
            Slinq<T2, C2> with, DelegateFunc<Option<T>, Option<T2>, P, U> selector, P parameter)
        {
	    ...
	    /// </summary>
	    public static Slinq<ValueTuple<T, int>, ZipContext<int, FuncContext<int, int>, T, C>> ZipWithIndex<T, C>(
            this Slinq<T, C> slinq)
        {
            return ZipContext<int, FuncContext<int, int>, T, C>.Zip(slinq, Slinqable.Sequence(0, 1),
                ZipRemoveFlags.Left);
        }
...
//		}
	    ...
	    public static Option<float> AverageOrNone<C>(this Slinq<float, C> slinq)
        {
            if (slinq.current.isSome)
            {
                ...
                return new Option<float>(acc / count);
            }
