...
#pragma warning restore 0414
    ...
    public struct PredicateContext<T, C, P>
    {
        ...
        public static Slinq<T, PredicateContext<T, C, P>> TakeWhile(Slinq<T, C> slinq,
        ...
        public static Slinq<T, PredicateContext<T, C, P>> Where(Slinq<T, C> slinq, DelegateFunc<T, P, bool> predicate,
            P parameter)
        {
            return new Slinq<T, PredicateContext<T, C, P>>(
                whereSkip,
...
#pragma warning restore 0414
        ...
        private static void WhereSkip(ref PredicateContext<T, C, P> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   !context.predicate(context.chained.current.value, context.parameter))
                context.chained.skip(ref context.chained.context, out context.chained.current);
