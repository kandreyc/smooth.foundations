...
namespace Smooth.Slinq.Context
{
    ...
    public struct SelectSlinqContext<U, UC, T, C>
    {
        ...
        public static Slinq<U, SelectSlinqContext<U, UC, T, C>> SelectMany(Slinq<T, C> slinq,
...
#pragma warning restore 0414
    ...
    public struct SelectSlinqContext<U, UC, T, C, P>
    {
        ...
        public static Slinq<U, SelectSlinqContext<U, UC, T, C, P>> SelectMany(Slinq<T, C> slinq,
