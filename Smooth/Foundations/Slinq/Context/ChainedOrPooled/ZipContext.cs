...
#pragma warning restore 0414
    ...
    public struct ZipContext<U, T2, C2, T, C>
    {
        ...
        public static Slinq<U, ZipContext<U, T2, C2, T, C>> Zip(Slinq<T, C> left, Slinq<T2, C2> right,
            DelegateFunc<T, T2, U> selector, ZipRemoveFlags removeFlags)
        {
...
#pragma warning restore 0414
        ...
        private ZipContext(Slinq<T, C> left, Slinq<T2, C2> right, DelegateFunc<T, T2, U> selector,
            ZipRemoveFlags removeFlags)
        {
            needsMove = false;
            this.left = left;
    ...
    public struct ZipContext<U, T2, C2, T, C, P>
    {
        ...
        public static Slinq<U, ZipContext<U, T2, C2, T, C, P>> Zip(Slinq<T, C> left, Slinq<T2, C2> right,
            DelegateFunc<T, T2, P, U> selector, P parameter, ZipRemoveFlags removeFlags)
        {
...
#pragma warning restore 0414
        ...
        private ZipContext(Slinq<T, C> left, Slinq<T2, C2> right, DelegateFunc<T, T2, P, U> selector, P parameter,
            ZipRemoveFlags removeFlags)
        {
            needsMove = false;
            this.left = left;
