...
namespace Smooth.Slinq.Context
{
    public struct GroupByContext<K, T>
    {
        ...
        public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> Slinq(Lookup<K, T> lookup,
            bool release)
        {
...
#pragma warning restore 0414
        ...
        private static void SlinqedSkip(ref GroupByContext<K, T> context,
            out Option<Grouping<K, T, LinkedContext<T>>> next)
        {
            context.bd.DetectBacktrack();
        ...
        private static void SlinqedRemove(ref GroupByContext<K, T> context,
            out Option<Grouping<K, T, LinkedContext<T>>> next)
        {
            throw new NotSupportedException();
        }

        private static void SlinqedDispose(ref GroupByContext<K, T> context,
            out Option<Grouping<K, T, LinkedContext<T>>> next)
        {
            next = new Option<Grouping<K, T, LinkedContext<T>>>();
            context.bd.Release();
