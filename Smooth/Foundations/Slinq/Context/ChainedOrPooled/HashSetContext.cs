...
namespace Smooth.Slinq.Context
{
    ...
    public struct HashSetContext<T, C>
    {
        ...
        public static Slinq<T, HashSetContext<T, C>> Distinct(Slinq<T, C> slinq, Disposable<HashSet<T>> hashSet,
            bool release)
        {
        ...
        public static Slinq<T, HashSetContext<T, C>> Except(Slinq<T, C> slinq, Disposable<HashSet<T>> hashSet,
            bool release)
        {
            return new Slinq<T, HashSetContext<T, C>>(
                exceptSkip,
        ...
        public static Slinq<T, HashSetContext<T, C>> Intersect(Slinq<T, C> slinq, Disposable<HashSet<T>> hashSet,
            bool release)
        {
            return new Slinq<T, HashSetContext<T, C>>(
                intersectSkip,
...
#pragma warning restore 0414
        ...
        private static void Dispose(ref HashSetContext<T, C> context, out Option<T> next)
        {
            ...
            if (context.release) context.hashSet.Dispose();
        }
    ...
    public struct HashSetContext<K, T, C>
    {
        ...
        public static Slinq<T, HashSetContext<K, T, C>> Distinct(Slinq<T, C> slinq, DelegateFunc<T, K> selector,
            Disposable<HashSet<K>> hashSet, bool release)
        {
        ...
        public static Slinq<T, HashSetContext<K, T, C>> Except(Slinq<T, C> slinq, DelegateFunc<T, K> selector,
            Disposable<HashSet<K>> hashSet, bool release)
        {
            return new Slinq<T, HashSetContext<K, T, C>>(
                exceptSkip,
        ...
        public static Slinq<T, HashSetContext<K, T, C>> Intersect(Slinq<T, C> slinq, DelegateFunc<T, K> selector,
            Disposable<HashSet<K>> hashSet, bool release)
        {
            return new Slinq<T, HashSetContext<K, T, C>>(
                intersectSkip,
...
#pragma warning restore 0414
        ...
        private HashSetContext(Slinq<T, C> chained, DelegateFunc<T, K> selector, Disposable<HashSet<K>> hashSet,
            bool release)
        {
            needsMove = false;
            this.chained = chained;
        ...
        private static void DistinctSkip(ref HashSetContext<K, T, C> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   !context.hashSet.value.Add(context.selector(context.chained.current.value)))
                context.chained.skip(ref context.chained.context, out context.chained.current);
        ...
        private static void ExceptSkip(ref HashSetContext<K, T, C> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   context.hashSet.value.Contains(context.selector(context.chained.current.value)))
                context.chained.skip(ref context.chained.context, out context.chained.current);
        ...
        private static void IntersectSkip(ref HashSetContext<K, T, C> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   !context.hashSet.value.Remove(context.selector(context.chained.current.value)))
                context.chained.skip(ref context.chained.context, out context.chained.current);
    ...
    public struct HashSetContext<K, T, C, P>
    {
        ...
        public static Slinq<T, HashSetContext<K, T, C, P>> Distinct(Slinq<T, C> slinq, DelegateFunc<T, P, K> selector,
            P parameter, Disposable<HashSet<K>> hashSet, bool release)
        {
        ...
        public static Slinq<T, HashSetContext<K, T, C, P>> Except(Slinq<T, C> slinq, DelegateFunc<T, P, K> selector,
            P parameter, Disposable<HashSet<K>> hashSet, bool release)
        {
            return new Slinq<T, HashSetContext<K, T, C, P>>(
                exceptSkip,
        ...
        public static Slinq<T, HashSetContext<K, T, C, P>> Intersect(Slinq<T, C> slinq, DelegateFunc<T, P, K> selector,
            P parameter, Disposable<HashSet<K>> hashSet, bool release)
        {
            return new Slinq<T, HashSetContext<K, T, C, P>>(
                intersectSkip,
...
#pragma warning restore 0414
        ...
        private HashSetContext(Slinq<T, C> chained, DelegateFunc<T, P, K> selector, P parameter,
            Disposable<HashSet<K>> hashSet, bool release)
        {
            needsMove = false;
            this.chained = chained;
        ...
        private static void DistinctSkip(ref HashSetContext<K, T, C, P> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   !context.hashSet.value.Add(context.selector(context.chained.current.value, context.parameter)))
                context.chained.skip(ref context.chained.context, out context.chained.current);
        ...
        private static void ExceptSkip(ref HashSetContext<K, T, C, P> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   context.hashSet.value.Contains(context.selector(context.chained.current.value, context.parameter)))
                context.chained.skip(ref context.chained.context, out context.chained.current);
        ...
        private static void IntersectSkip(ref HashSetContext<K, T, C, P> context, out Option<T> next)
        {
            ...
            while (context.chained.current.isSome &&
                   !context.hashSet.value.Remove(context.selector(context.chained.current.value, context.parameter)))
                context.chained.skip(ref context.chained.context, out context.chained.current);
