...
namespace Smooth.Slinq.Context
{
    ...
    public struct AggregateContext<U, T, C>
    {
        ...
        public static Slinq<U, AggregateContext<U, T, C>> AggregateRunning(Slinq<T, C> slinq, U seed,
...
#pragma warning restore 0414
    ...
    public struct AggregateContext<U, T, C, P>
    {
        ...
        public static Slinq<U, AggregateContext<U, T, C, P>> AggregateRunning(Slinq<T, C> slinq, U seed,
            DelegateFunc<U, T, P, U> selector, P parameter)
        {
