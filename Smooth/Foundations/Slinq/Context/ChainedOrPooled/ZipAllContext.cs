...
#pragma warning restore 0414
    ...
    public struct ZipAllContext<U, T2, C2, T, C>
    {
        ...
        public static Slinq<U, ZipAllContext<U, T2, C2, T, C>> ZipAll(Slinq<T, C> left, Slinq<T2, C2> right,
            DelegateFunc<Option<T>, Option<T2>, U> selector, ZipRemoveFlags removeFlags)
        {
...
#pragma warning restore 0414
        ...
        private ZipAllContext(Slinq<T, C> left, Slinq<T2, C2> right, DelegateFunc<Option<T>, Option<T2>, U> selector,
    ...
    public struct ZipAllContext<U, T2, C2, T, C, P>
    {
        ...
        public static Slinq<U, ZipAllContext<U, T2, C2, T, C, P>> ZipAll(Slinq<T, C> left, Slinq<T2, C2> right,
            DelegateFunc<Option<T>, Option<T2>, P, U> selector, P parameter, ZipRemoveFlags removeFlags)
        {
...
#pragma warning restore 0414
        ...
        private ZipAllContext(Slinq<T, C> left, Slinq<T2, C2> right, DelegateFunc<Option<T>, Option<T2>, P, U> selector,
